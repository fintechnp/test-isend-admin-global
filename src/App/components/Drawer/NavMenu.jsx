...
const NavMenu = () => {
    ...
    return (
        <div className="nav" style={styles.nav}>
            <input type="checkbox" checked={checked} onChange={handleCheckboxChange} style={styles.input} />
            <svg style={styles.svg}>
                <use
                    xlinkHref="#menu"
                    style={{
                        ...styles.use,
                        ...(checked ? styles.useChecked1 : styles.useUnchecked1),
                    }}
                />
                <use
                    xlinkHref="#menu"
                    style={{
                        ...styles.use,
                        ...(checked ? styles.useChecked2 : styles.useUnchecked2),
                    }}
                />
            </svg>
