...
import { useFlexLayout, useExpanded, usePagination, useRowSelect, useTable } from "react-table";
                            ...
                            {headerGroups.map((headerGroup, index) => (
                                ...
                                >
                                    {headerGroup.headers.map((column, index) => {
                                        return (
                                            <HeadCell {...column.getHeaderProps()} key={index}>
                    ...
                    <TableBody>
                        {loading ? (
                            ...
                            rows.map((row, i) => {
                                prepareRow(row);
                                return (
                                    <BoxContainer key={i} open={row?.isExpanded}>
