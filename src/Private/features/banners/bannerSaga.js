...
export const updateBanner = takeEvery(actions.UPDATE_BANNER, function* (action) {
    try {
...
export const updateBannerStatus = takeEvery(actions.UPDATE_BANNER_STATUS, function* (action) {
...
export const deleteBanner = takeEvery(actions.DELETE_BANNER, function* (action) {
    try {
...
export default function* bannerSaga() {
    yield all([getBanners, getBanner, addBanner, updateBanner, updateBannerStatus, deleteBanner]);
}
