...
export const getAllReference = takeEvery(
    actions.GET_REFERENCE,
    function* (action) {
        try {
            const res = yield call(
                api.get,
                `common/referencetype`,
                action.query
            );
...
export const addReference = takeEvery(
...
export const updateReference = takeEvery(
    actions.UPDATE_REFERENCE,
    function* (action) {
        try {
            const res = yield call(
                api.put,
                `common/referencetype/${action.id}`,
                action.data
            );
            yield put({
...
export const getAllReferenceData = takeEvery(
    actions.GET_REFERENCE_DATA,
    function* (action) {
        try {
            const res = yield call(
                api.get,
                `common/${action.id}/referencedata`,
                action.query
            );
            yield put({
...
export const addReferenceData = takeEvery(
    actions.ADD_REFERENCE_DATA,
    function* (action) {
        try {
            const res = yield call(
                api.post,
...
export const updateReferenceData = takeEvery(
    actions.UPDATE_REFERENCE_DATA,
    function* (action) {
        try {
            const res = yield call(
                api.put,
...
export const deleteReferenceData = takeEvery(
