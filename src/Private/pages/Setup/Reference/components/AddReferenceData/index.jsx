...
function AddReferenceData({ update_data, update, id, enablePopoverAction = false }) {
    const dispatch = useDispatch();
    const [open, setOpen] = React.useState(false);
    const { success: add_success, loading: add_loading } = useSelector((state) => state.add_reference_data);
    const { success: update_success, loading: update_loading } = useSelector((state) => state.update_reference_data);
