...
export const getAllDeliveryOption = takeEvery(actions.GET_DELIVERY_OPTION, function* (action) {
    try {
...
export const getDeliveryOptionDetails = takeEvery(actions.GET_DELIVERY_OPTION_DETAILS, function* (action) {
    try {
...
export const addDeliveryOption = takeEvery(actions.ADD_DELIVERY_OPTION, function* (action) {
    try {
...
export const updateDeliveryOption = takeEvery(actions.UPDATE_DELIVERY_OPTION, function* (action) {
    try {
...
export const updateDeliveryOptionStatus = takeEvery(actions.UPDATE_DELIVERY_OPTION_STATUS, function* (action) {
    const query = api.getJSONToQueryStr(action.data);
    try {
        const res = yield call(api.patch, `deliveryoption/${action.id}?${query}`);
        yield put({
...
export const deleteDeliveryOption = takeEvery(actions.DELETE_DELIVERY_OPTION, function* (action) {
    try {
