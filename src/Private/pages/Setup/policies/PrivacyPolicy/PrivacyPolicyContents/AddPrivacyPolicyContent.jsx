...
const AddPrivacyPolicyContent = () => {
    ...
    const { response: PPDocumentList } = useSelector((state) => state.get_document_file_list);

    const ListOrderID = PPDocumentList?.pagination?.totalCount;
    ...
    return (
        <Modal
            ...
            title="Add Privacy Policy Content"
            open={isOpen}
            onClose={handleClose}
        >
...
export default AddPrivacyPolicyContent;
