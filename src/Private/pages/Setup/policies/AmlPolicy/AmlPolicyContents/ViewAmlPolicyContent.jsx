...
const ViewAmlPolicyContent = () => {
    const dispatch = useDispatch();

    const { is_modal_open: isOpen, initial_form_state: initialData } = useSelector(
        (state) => state.get_document_file_content_by_id,
    );
    ...
    const AmlDefinition = useSourceDetail([
        {
            title: "",
            items: [
                {
...
export default ViewAmlPolicyContent;
