...
export const getAllPayoutLocation = takeEvery(
    actions.GET_PAYOUT_LOCATION,
    function* (action) {
        try {
...
export const getPayoutLocationDetails = takeEvery(
    actions.GET_PAYOUT_LOCATION_DETAILS,
    function* (action) {
        try {
...
export const addPayoutLocation = takeEvery(
    actions.ADD_PAYOUT_LOCATION,
    function* (action) {
        try {
...
export const updatePayoutLocation = takeEvery(
    actions.UPDATE_PAYOUT_LOCATION,
    function* (action) {
        try {
            const res = yield call(
                api.put,
                `payoutlocation/${action.id}`,
                action.data
            );
            yield put({
