...
export const getApiConfig = takeEvery(actions.GET_API_CONFIG, function* (action) {
    try {
...
export const getApiConfigDetails = takeEvery(actions.GET_API_CONFIG_DETAILS, function* (action) {
    try {
...
export const addApiConfig = takeEvery(actions.ADD_API_CONFIG, function* (action) {
    try {
...
export const updateApiConfig = takeEvery(actions.UPDATE_API_CONFIG, function* (action) {
    try {
        const res = yield call(api.put, `apiconfig/${action.id}`, action.data);
        yield put({
...
export default function* saga() {
    yield all([getApiConfig, getApiConfigDetails, addApiConfig, updateApiConfig]);
}
