...
export const getAllPartnerBank = takeEvery(
    actions.GET_ALL_PARTNER_BANK,
    function* (action) {
        try {
...
export const getPartnerBankById = takeEvery(
    actions.GET_PARTNER_BANK_BYID,
    function* (action) {
        try {
...
export const getPartnerBankByAgentId = takeEvery(
    actions.GET_PARTNER_BANK_AGENT_ID,
    function* (action) {
        try {
...
export const createPartnerBank = takeEvery(
    actions.CREATE_PARTNER_BANK,
    function* (action) {
        try {
...
export const updatePartnerBank = takeEvery(
    actions.UPDATE_PARTNER_BANK,
    function* (action) {
        try {
            const res = yield call(
                api.put,
                `partnerbank/${action.id}`,
                action.data
            );
            yield put({
