...
export default function DashboardTransactionAmount() {
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.amountData.pendingData.totalDifferenceInPercentage}%
                                            {""}
                                        </Typography>
                                    </Row>
                                </Row>
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.amountData.payoutData.totalDifferenceInPercentage}%
                                            {""}
                                        </Typography>
                                    </Row>
                                </Row>
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.amountData.cancelledData.totalDifferenceInPercentage}
                                            %{""}
                                        </Typography>
                                    </Row>
                                </Row>
