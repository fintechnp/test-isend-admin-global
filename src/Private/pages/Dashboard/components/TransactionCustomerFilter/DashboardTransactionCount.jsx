...
export default function DashboardTransactionCount() {
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.countData.pendingData.totalDifferenceInPercentage}%{" "}
                                        </Typography>
                                    </Row>
                                </Row>
                            )}
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.countData.payoutData.totalDifferenceInPercentage}%{" "}
                                        </Typography>
                                    </Row>
                                </Row>
                            )}
                            ...
                            {totalTransactionsData.isSubDataLoading ? (
                                ...
                                <Row gap={1}>
                                    ...
                                    <Row alignItems="center" gap="4px">
                                        ...
                                        >
                                            {totalTransactionsData.countData.cancelledData.totalDifferenceInPercentage}%{" "}
                                        </Typography>
                                    </Row>
                                </Row>
                            )}
