...
function ACHEntriesFilterForm({ onSubmit, onReset }) {
        ...
        <HookForm onSubmit={onSubmit} {...methods}>
            <Grid container rowSpacing={2} columnSpacing={3}>
                <Grid item xs={12} sm={6} md={4}>
                    <FormTextField name="ach_id" label="ACH ID" />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                    <FormSelect
                        name="txn_type"
                ...
                <Grid item xs={12} sm={6} md={4}>
                    <FormSelect name="status" label="Status" options={achConfig.status.options()} />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
...
export default ACHEntriesFilterForm;
