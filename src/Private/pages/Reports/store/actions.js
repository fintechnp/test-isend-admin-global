const actions = {
    ...
    CAMPAIGN_LEDGER_REPORT: "CAMPAIGN_LEDGER_REPORT",
    CAMPAIGN_LEDGER_REPORT_SUCCESS: "CAMPAIGN_LEDGER_REPORT_SUCCESS",
    CAMPAIGN_LEDGER_REPORT_FAILED: "CAMPAIGN_LEDGER_REPORT_FAILED",
    CAMPAIGN_LEDGER_REPORT_RESET: "CAMPAIGN_LEDGER_REPORT_RESET",

    CAMPAIGN_REPORT: "CAMPAIGN_REPORT",
    CAMPAIGN_REPORT_SUCCESS: "CAMPAIGN_REPORT_SUCCESS",
    CAMPAIGN_REPORT_FAILED: "CAMPAIGN_REPORT_FAILED",
    CAMPAIGN_REPORT_RESET: "CAMPAIGN_REPORT_RESET",

    CAMPAIGN_REPORT_DETAILS: "CAMPAIGN_REPORT_DETAILS",
    CAMPAIGN_REPORT_DETAILS_SUCCESS: "CAMPAIGN_REPORT_DETAILS_SUCCESS",
    ...
    CAMPAIGN_INCENTIVE_REPORT: "CAMPAIGN_INCENTIVE_REPORT",
    CAMPAIGN_INCENTIVE_REPORT_SUCCESS: "CAMPAIGN_INCENTIVE_REPORT_SUCCESS",
    CAMPAIGN_INCENTIVE_REPORT_FAILED: "CAMPAIGN_INCENTIVE_REPORT_FAILED",
    CAMPAIGN_INCENTIVE_REPORT_RESET: "CAMPAIGN_INCENTIVE_REPORT_RESET",

    CAMPAIGN_INCENTIVE_REPORT_STATUS: "CAMPAIGN_INCENTIVE_REPORT_STATUS",
    CAMPAIGN_INCENTIVE_REPORT_STATUS_SUCCESS: "CAMPAIGN_INCENTIVE_REPORT_STATUS_SUCCESS",
    CAMPAIGN_INCENTIVE_REPORT_STATUS_FAILED: "CAMPAIGN_INCENTIVE_REPORT_STATUS_FAILED",
    CAMPAIGN_INCENTIVE_REPORT_STATUS_RESET: "CAMPAIGN_INCENTIVE_REPORT_STATUS_RESET",

    OPEN_CAMPAIGN_INCENTIVE_REPORT_MODAL: "OPEN_CAMPAIGN_INCENTIVE_REPORT_MODAL",
    CLOSE_CAMPAIGN_INCENTIVE_REPORT_MODAL: "CLOSE_CAMPAIGN_INCENTIVE_REPORT_MODAL",
    ...
    get_campaign_reports: (query) => ({
        type: actions.CAMPAIGN_REPORT,
        query,
    }),

    get_campaign_report_details: (query) => ({
        type: actions.CAMPAIGN_REPORT_DETAILS,
        query,
    }),
    ...
    get_campaign_incentive_report: (query) => ({
        type: actions.CAMPAIGN_INCENTIVE_REPORT,
        query,
    }),

    update_campaign_incentive_status: (id, data) => ({
        type: actions.CAMPAIGN_INCENTIVE_REPORT_STATUS,
        data,
        id,
    }),

    open_campaign_incentive_modal: (payload) => ({
        type: actions.OPEN_CAMPAIGN_INCENTIVE_REPORT_MODAL,
        payload,
    }),

    close_campaign_incentive_modal: () => ({
        type: actions.CLOSE_CAMPAIGN_INCENTIVE_REPORT_MODAL,
    }),
