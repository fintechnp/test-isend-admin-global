...
export const getSanctionList = takeEvery(actions.GET_SANCTION_LIST, function* (action) {
    try {
...
export const importSanctionList = takeEvery(actions.IMPORT_SANCTION_LIST, function* (action) {
    try {
...
export const getSanctionById = takeEvery(actions.GET_SANCTION_BY_ID, function* (action) {
    try {
...
export const updateSanction = takeEvery(actions.UPDATE_SANCTION, function* (action) {
    try {
        const res = yield call(api.put, `sanction/${action.id}`, action.data);
        yield put({
...
export const deleteSanction = takeEvery(actions.DELETE_SANCTION, function* (action) {
    try {
...
export default function* saga() {
    yield all([getSanctionList, getSanctionById, importSanctionList, addSanction, updateSanction, deleteSanction]);
}
