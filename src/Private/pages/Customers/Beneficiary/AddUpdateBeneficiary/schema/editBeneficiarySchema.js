...
export const editForm1Schema = Yup.object().shape({
...
export const editForm2Schema = editForm1Schema.concat(
    Yup.object().shape({
...
export const editForm3Schema = editForm2Schema.concat(
    Yup.object().shape({
...
const editBeneficiarySchema = editForm3Schema;

export default editBeneficiarySchema;
