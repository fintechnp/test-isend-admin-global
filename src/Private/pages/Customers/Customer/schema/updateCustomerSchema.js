...
export const updateCustomerFormStep1Schema = Yup.object().shape({
...
export const updateCustomerFormStep2Schema = updateCustomerFormStep1Schema.shape({
    postcode: Yup.string()
...
export const updateCustomerFormStep3Schema = updateCustomerFormStep2Schema.shape({
